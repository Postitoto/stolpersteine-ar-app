...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        public RectTransform letterBoxArea;
        ...
        private void ApplyLetterBoxArea(Rect safeArea)
        {
            if (SceneManager.GetActiveScene().name.Equals("mainMenu"))
                return;
         
            if (letterBoxArea == null)
                return;

            float topLetterboxHeight = Screen.height - safeArea.yMax;
            letterBoxArea.anchoredPosition = new Vector2(0f, 5);
            letterBoxArea.sizeDelta = new Vector2(Screen.width, topLetterboxHeight);
        }
    }
}
